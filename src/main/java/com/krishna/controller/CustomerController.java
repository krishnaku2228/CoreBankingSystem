...
public class CustomerController 
{
  ...
  @DeleteMapping(value="/deletecustomer/{accountNo}")
  public ResponseEntity<String> deleteCustomerByAccountNo(@PathVariable("accountNo") String accountNo) 
  {
	  try {
		  String deleteResponse=null;
	 if(accountNo!=null) {
		 deleteResponse=customerService.deleteCustomerByAccountNo(accountNo);
